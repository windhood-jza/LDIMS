...
// 创建接口
interface ExportTaskCreationAttributes
  extends Optional<ExportTaskAttributes, "id" | "createdAt" | "updatedAt"> {}

// 模型类 (保持 camelCase)
class ExportTask
  extends Model<ExportTaskAttributes, ExportTaskCreationAttributes>
  implements ExportTaskAttributes
{
  public id!: number;
