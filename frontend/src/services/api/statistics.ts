 ...
 */
export const getStatsByDepartment = (params?: DateRangeParams): Promise<NameValueData[]> => {
 ...
 */
export const getStatsByDocType = (params?: DateRangeParams): Promise<NameValueData[]> => {
