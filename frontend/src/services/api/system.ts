...
import type { OperationLogQuery, OperationLogInfo } from "@ldims/types"; // 从共享类型包导入
 ...
 */
export const updateSystemConfigs = (
  data: Partial<SystemConfigMap>
): Promise<void> => {
 ...
 */
export const getDbStatus = (): Promise<{
  connected: boolean;
  message: string;
}> => {
